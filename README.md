...
<h3 align="center">petstore-backend</h3>
...
* [Postgresql](https://www.postgresq.org/)
...
Petstore is a rust project, so you may need to have a rust development
environment. Instructions on how to do that are found on the [rust
...
2. Install docker-compose v2
    See [docker](https://docs.docker.com/compose/cli-command/#install-on-linux) for details 
...
2. Execute integration tests
  Requires a backend and a database to test against. You docker-compose:
